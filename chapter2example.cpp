// chapter2example.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
/* program file name : chapter2example
programmer: Miya Haines
Date: August 2025
Requirements: 
